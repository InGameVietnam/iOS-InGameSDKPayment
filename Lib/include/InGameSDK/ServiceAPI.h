...
- (void) onRequestButtonConfigFinish:(NSDictionary*) dict;
...
- (void) requestGetConfigPayment;
- (void) requestCardPaymentWithCardinfo:(CardInfo*) card andGameOrder:(NSString*) gameOrder;
- (void) requestBankPaymentWithAmount:(NSString*) amount andGameOrder:(NSString*) gameOrder;
- (void) requestApplePaymentWithReceipt:(NSString*) receipt andPassword:(NSString*) password forProductId:(NSString*)productId andGameOrder:(NSString*) gameOrder;
- (void) requestBankPaymentConfirmWithTransactionReceipt:(NSString *)receipt;
